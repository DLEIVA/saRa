...
numSummaryOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "numSummaryOptions",
...
numSummaryResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "numSummaryResults",
...
numSummaryBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "numSummaryBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(0,1,1),
                options = options,
                results = numSummaryResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
numSummary <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("numSummary requires jmvcore to be installed (restart may be required)")
